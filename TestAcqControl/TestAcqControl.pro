#-------------------------------------------------
#
# Project created by QtCreator 2021-04-15T19:32:13
#
#-------------------------------------------------
...
#Use build library type: Qt | MSVC
#win32-msvc* {
#COMPILER = Qt
#} else {
#COMPILER = QtMingw
...
#message("x86 build")
#CONFIG(release, debug|release): DESTDIR = ../lib/$${COMPILER}/Win32/release
#else:CONFIG(debug, debug|release): DESTDIR = ../lib/$${COMPILER}/Win32/debug
#    } else {
#message("x86_64 build")
#CONFIG(release, debug|release): DESTDIR = ../lib/$${COMPILER}/x64/release
#else:CONFIG(debug, debug|release): DESTDIR = ../lib/$${COMPILER}/x64/debug
#    }
#}
